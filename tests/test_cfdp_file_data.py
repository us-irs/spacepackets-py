...
from spacepackets.cfdp.pdu.file_data import FileDataPdu, SegmentMetadataFlag, \
...
class TestFileDataPdu(TestCase):
    def test_file_data_pdu(self):
        ...
        self.assertEqual(file_data_pdu.segment_metadata_flag, False)
        ...
        fd_pdu_with_metadata = FileDataPdu(
            pdu_conf=pdu_conf,
            file_data=file_data_bytes,
            offset=0,
        ...
        self.assertEqual(
            fd_pdu_with_metadata_unpacked.record_continuation_state,
        ...
        fd_pdu_large_offset_unpacked = FileDataPdu.unpack(raw_packet=fd_pdu_large_offset_raw)
        self.assertEqual(fd_pdu_large_offset_unpacked.segment_metadata, bytes([0xaa, 0xbb]))
