...
class TestTmFrame(TestCase):
    ...
    def test_pack_unpack_primary_header(self):
        ...
        self.assertEqual(
            prim_header.master_ch_frame_count, unpacked.master_ch_frame_count
        )
        self.assertEqual(prim_header.vc_frame_count, unpacked.vc_frame_count)
        self.assertEqual(
            prim_header.frame_datafield_status, unpacked.frame_datafield_status
        )
    ...
    def test_pack_secondary_header_data_too_long(self):
        ...
        self.assertRaises(
            ValueError, TransferFrameSecondaryHeader.pack, secondary_header
        )
